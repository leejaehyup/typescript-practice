...
type Primitive = 'string' | 'number' | 'array' | 'boolean' | 'object';
...
type JSONSchema2TS<U extends Property> = U extends {
  type: infer T extends Primitive;
  enum: infer E extends string[];
  properties: infer P extends Property;
  required: infer R;
  items: infer I extends Property;
}
  ? E extends undefined
